...
public class MainActivity extends BaseActivity {
    ...
    private LinearLayout linLayToogleMenu;
    ...
    protected void findViewById() {
        ...
        linLayToogleMenu = (LinearLayout) findViewById(R.id.linlay_toggle_menu);
    ...
    protected void setListener() {
        ...
        linLayToogleMenu.setOnClickListener(new OnClickListener() {
            @Override
    ...
    protected void dealProcessLogic() {
        ...
        lvMenu.setAdapter(menuItemHelper);
